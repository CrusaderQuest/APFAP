...
//start data.MemoryCalendarStore
/*
...
//start form.field.CalendarCombo
/**
...
//start form.field.ReminderCombo
/**
...
Ext.define('Ext.calendar.data.MemoryEventStore', {
    ...
    proxy: {
        type: 'memory',
        //url : 'file:///C:/Users/JinSung/Desktop/%EA%B3%B5%EB%AA%A8%EC%A0%84/ext-5.1.0-gpl/ext-5.1.0/build/examples/calendar/data.js'
        reader: {
            type: 'json',
            rootProperty: 'evts'
        },
...
Ext.define('Ext.calendar.App', {
    ...
    constructor : function() {
        ...
        getVersion = function (store) {
            var pr = DBParams.create('sp_ComFormB01', 'GET_VERSION');
            var ds = DBconnect.runProcedure(pr);
            var tempStore = ds[0];
